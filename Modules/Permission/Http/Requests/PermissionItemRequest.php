...
class PermissionItemRequest extends FormRequestAbstract
{
    /**
    ...
    protected function getRules()
    {
        $rules = [
            ...
            'code'       => ['nullable', 'string', 'max:220', 'unique:permission_items,code'],
            'type'       => ['nullable', Rule::in(PermissionItemTypeEnum::keys())],
    ...
    protected function postRules()
    {
        $rules = [
            ...
            'code'       => ['required', 'string', 'max:220', 'unique:permission_items,code'],
            'type'       => ['required', Rule::in(PermissionItemTypeEnum::keys())],
            'icon'       => ['nullable', 'string', 'max:220'],
            'icon_type'  => ['nullable', 'string', 'max:220'],
            'status'     => ['nullable', Rule::in(StatusEnum::keys())],
        ];

                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="w-full border-collapse  border-slate-500">
                        ...
                        <tr class="bg-gray-700 text-white text-left">
                            ...
                            <th class="p-2">Celular 1</th>
                            <th class="p-2">Celular 2</th>
                        ...
                        @foreach($items as $item)
                            <tr class="hover:bg-gray-100 border-t-2 border-gray-700">
                                ...
                                <td class="p-2">{{$item->nivel->nome}}</td>
                                <td class="p-2">{{$item->username}}</td>
                                <td class="p-2">{{$item->celular_1}}</td>
                                <td class="p-2">{{$item->celular_2}}</td>
                                <td class="p-2">{{$item->cadastro}}</td>
                                <td class="p-2">
